 ...
 * data source for the mobile app, scoped to the Sanctum-authenticated user.
 * Identical to Web\SearchController other than the guard; additive only,
 * doesn't change any existing mobile endpoint.
 */
